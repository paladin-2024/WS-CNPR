...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { font-family: var(--font-primary); background: #F0F4F8; display: flex; align-items: center; justify-content: center; min-height: 100vh; }
        .container { text-align: center; padding: 40px; }
        .code { font-size: 120px; font-weight: 800; color: #E2E8F0; line-height: 1; }
        h1 { font-size: 24px; color: var(--admin-navy); margin: 16px 0 8px; }
        p { color: var(--admin-slate); margin-bottom: 24px; }
